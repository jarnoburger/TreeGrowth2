...
namespace TreeGrowth
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            InitializeBloomPanel();
            InitializePerlinPanel();
        ...
        private void InitializeMenuStrip()
        {
            ...
            _fileMenuItem.DropDownItems.AddRange(new ToolStripItem[] {
                _saveSettingsMenuItem, _saveSettingsAsMenuItem, _loadSettingsMenuItem,
                _revertToDefaultsMenuItem, _menuSeparator, _exitMenuItem
            });
        ...
        private void InitializeVisualPanel()
        {
            ...
            InitializeVisualTrackBars();
            InitializeVisualColorButtons();
            InitializeVisualComboBoxes();
        }

        private void InitializeVisualTrackBars()
        {
        ...
        private void InitializeVisualColorButtons()
        {
        ...
        private void InitializeVisualComboBoxes()
        {
            ...
            _presetCombo.Items.AddRange(new object[] {
                "Warm", "Atmosphere", "Forest", "Night",
                "ANWB", "Infrared", "Ocean", "Monochrome"
            });
            ...
            _gridSizeCombo.Items.AddRange(new object[] {
                "1920×1080 HD", "1024×1024", "2560×1440 QHD",
                "3840×2160 4K", "512×512 Fast"
            });
            ...
            _cellSizeCombo.Items.AddRange(new object[] {
                "1×1 Fine", "2×2", "4×4", "8×8 Chunky", "16×16 LED"
            });
        ...
        private void InitializeBloomPanel()
        {
        ...
        private void InitializePerlinPanel()
        {
            ...
            _perlinHeader.Size = new Size(255, 25);
            ...
            _perlinCheck.Size = new Size(198, 29);
            ...
            _noiseScaleLabel.Size = new Size(111, 21);
            ...
            _noiseOctavesLabel.Size = new Size(83, 21);
            ...
            _noiseThresholdLabel.Size = new Size(133, 21);
            ...
            _noiseStrengthLabel.Size = new Size(119, 21);
