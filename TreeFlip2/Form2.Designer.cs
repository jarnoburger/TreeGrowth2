...
namespace TreeGrowth
{
    partial class Form2
    {
        ...
        private System.Windows.Forms.CheckBox _perlinCheck;
        private System.Windows.Forms.TrackBar _noiseScaleBar;
        private System.Windows.Forms.Label _noiseScaleLabel;
        private System.Windows.Forms.TrackBar _noiseOctavesBar;
        private System.Windows.Forms.Label _noiseOctavesLabel;
        private System.Windows.Forms.TrackBar _noiseThresholdBar;
        private System.Windows.Forms.Label _noiseThresholdLabel;
        private System.Windows.Forms.TrackBar _noiseStrengthBar;
        private System.Windows.Forms.Label _noiseStrengthLabel;
        private System.Windows.Forms.Panel _perlinPanel;
        private System.Windows.Forms.Label _perlinHeader;
        ...
        private System.Windows.Forms.Button _overlayLoadBtn;
        private System.Windows.Forms.CheckBox _overlayToggle;
        ...
        private void InitializeComponent()
        {
            ...
            _perlinPanel = new Panel();
            _perlinHeader = new Label();
            _perlinCheck = new CheckBox();
            _noiseScaleBar = new TrackBar();
            _noiseScaleLabel = new Label();
            _noiseOctavesBar = new TrackBar();
            _noiseOctavesLabel = new Label();
            _noiseThresholdBar = new TrackBar();
            _noiseThresholdLabel = new Label();
            _noiseStrengthBar = new TrackBar();
            _noiseStrengthLabel = new Label();
            ...
            _perlinPanel.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)_noiseScaleBar).BeginInit();
            ((System.ComponentModel.ISupportInitialize)_noiseOctavesBar).BeginInit();
            ((System.ComponentModel.ISupportInitialize)_noiseThresholdBar).BeginInit();
            ((System.ComponentModel.ISupportInitialize)_noiseStrengthBar).BeginInit();
            ...
            _neighborhoodCombo.FormattingEnabled = true;
            ...
            _presetCombo.FormattingEnabled = true;
            ...
            _gridSizeCombo.FormattingEnabled = true;
            ...
            _cellSizeCombo.FormattingEnabled = true;
            ...
            _bloomPanel.Controls.Add(_overlayToggle);
            _bloomPanel.Controls.Add(_overlayLoadBtn);
            ...
            // _overlayToggle
            // 
            _overlayToggle.AutoSize = true;
            _overlayToggle.ForeColor = Color.White;
            _overlayToggle.Location = new Point(823, 26);
            _overlayToggle.Name = "_overlayToggle";
            _overlayToggle.Size = new Size(147, 29);
            _overlayToggle.TabIndex = 1;
            _overlayToggle.Text = "Show Overlay";
            _overlayToggle.CheckedChanged += OnOverlayToggleChanged;
            // 
            // _overlayLoadBtn
            // 
            _overlayLoadBtn.BackColor = Color.FromArgb(80, 80, 120);
            _overlayLoadBtn.FlatStyle = FlatStyle.Flat;
            _overlayLoadBtn.ForeColor = Color.White;
            _overlayLoadBtn.Location = new Point(823, 67);
            _overlayLoadBtn.Name = "_overlayLoadBtn";
            _overlayLoadBtn.Size = new Size(150, 35);
            _overlayLoadBtn.TabIndex = 0;
            _overlayLoadBtn.Text = "Load Overlay...";
            _overlayLoadBtn.UseVisualStyleBackColor = false;
            _overlayLoadBtn.Click += OnOverlayLoadClick;
            // 
            // _bloomHeader
            // 
            ...
            _bloomFireOnlyCheck.Location = new Point(484, 50);
            ...
            // _perlinPanel
            // 
            _perlinPanel.BackColor = Color.FromArgb(35, 35, 35);
            _perlinPanel.Controls.Add(_perlinHeader);
            _perlinPanel.Controls.Add(_perlinCheck);
            _perlinPanel.Controls.Add(_noiseScaleBar);
            _perlinPanel.Controls.Add(_noiseScaleLabel);
            _perlinPanel.Controls.Add(_noiseOctavesBar);
            _perlinPanel.Controls.Add(_noiseOctavesLabel);
            _perlinPanel.Controls.Add(_noiseThresholdBar);
            _perlinPanel.Controls.Add(_noiseThresholdLabel);
            _perlinPanel.Controls.Add(_noiseStrengthBar);
            _perlinPanel.Controls.Add(_noiseStrengthLabel);
            _perlinPanel.Location = new Point(997, 1328);
            _perlinPanel.Name = "_perlinPanel";
            _perlinPanel.Padding = new Padding(15);
            _perlinPanel.Size = new Size(923, 120);
            _perlinPanel.TabIndex = 7;
            // 
            // _perlinHeader
            // 
            _perlinHeader.AutoSize = true;
            _perlinHeader.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            _perlinHeader.ForeColor = Color.FromArgb(100, 200, 255);
            _perlinHeader.Location = new Point(15, 5);
            _perlinHeader.Name = "_perlinHeader";
            _perlinHeader.Size = new Size(264, 25);
            _perlinHeader.TabIndex = 0;
            _perlinHeader.Text = "SPATIAL TREE DISTRIBUTION";
            // 
            // _perlinCheck
            // 
            _perlinCheck.AutoSize = true;
            _perlinCheck.ForeColor = Color.White;
            _perlinCheck.Location = new Point(15, 35);
            _perlinCheck.Name = "_perlinCheck";
            _perlinCheck.Size = new Size(189, 29);
            _perlinCheck.TabIndex = 1;
            _perlinCheck.Text = "Use Perlin Noise (P)";
            _perlinCheck.CheckedChanged += OnPerlinCheckChanged;
            // 
            // _noiseScaleBar
            // 
            _noiseScaleBar.BackColor = Color.FromArgb(35, 35, 35);
            _noiseScaleBar.Enabled = false;
            _noiseScaleBar.Location = new Point(220, 50);
            _noiseScaleBar.Maximum = 200;
            _noiseScaleBar.Minimum = 10;
            _noiseScaleBar.Name = "_noiseScaleBar";
            _noiseScaleBar.Size = new Size(130, 69);
            _noiseScaleBar.TabIndex = 2;
            _noiseScaleBar.TickFrequency = 20;
            _noiseScaleBar.Value = 50;
            _noiseScaleBar.Scroll += OnNoiseScaleScroll;
            // 
            // _noiseScaleLabel
            // 
            _noiseScaleLabel.AutoSize = true;
            _noiseScaleLabel.Font = new Font("Segoe UI", 8F);
            _noiseScaleLabel.ForeColor = Color.FromArgb(180, 180, 180);
            _noiseScaleLabel.Location = new Point(220, 30);
            _noiseScaleLabel.Name = "_noiseScaleLabel";
            _noiseScaleLabel.Size = new Size(105, 21);
            _noiseScaleLabel.TabIndex = 3;
            _noiseScaleLabel.Text = "Scale: 50 (1×)";
            // 
            // _noiseOctavesBar
            // 
            _noiseOctavesBar.BackColor = Color.FromArgb(35, 35, 35);
            _noiseOctavesBar.Enabled = false;
            _noiseOctavesBar.Location = new Point(365, 50);
            _noiseOctavesBar.Maximum = 8;
            _noiseOctavesBar.Minimum = 1;
            _noiseOctavesBar.Name = "_noiseOctavesBar";
            _noiseOctavesBar.Size = new Size(110, 69);
            _noiseOctavesBar.TabIndex = 4;
            _noiseOctavesBar.Value = 4;
            _noiseOctavesBar.Scroll += OnNoiseOctavesScroll;
            // 
            // _noiseOctavesLabel
            // 
            _noiseOctavesLabel.AutoSize = true;
            _noiseOctavesLabel.Font = new Font("Segoe UI", 8F);
            _noiseOctavesLabel.ForeColor = Color.FromArgb(180, 180, 180);
            _noiseOctavesLabel.Location = new Point(365, 30);
            _noiseOctavesLabel.Name = "_noiseOctavesLabel";
            _noiseOctavesLabel.Size = new Size(81, 21);
            _noiseOctavesLabel.TabIndex = 5;
            _noiseOctavesLabel.Text = "Octaves: 4";
            // 
            // _noiseThresholdBar
            // 
            _noiseThresholdBar.BackColor = Color.FromArgb(35, 35, 35);
            _noiseThresholdBar.Enabled = false;
            _noiseThresholdBar.Location = new Point(490, 50);
            _noiseThresholdBar.Maximum = 100;
            _noiseThresholdBar.Name = "_noiseThresholdBar";
            _noiseThresholdBar.Size = new Size(130, 69);
            _noiseThresholdBar.TabIndex = 6;
            _noiseThresholdBar.TickFrequency = 20;
            _noiseThresholdBar.Value = 30;
            _noiseThresholdBar.Scroll += OnNoiseThresholdScroll;
            // 
            // _noiseThresholdLabel
            // 
            _noiseThresholdLabel.AutoSize = true;
            _noiseThresholdLabel.Font = new Font("Segoe UI", 8F);
            _noiseThresholdLabel.ForeColor = Color.FromArgb(180, 180, 180);
            _noiseThresholdLabel.Location = new Point(490, 30);
            _noiseThresholdLabel.Name = "_noiseThresholdLabel";
            _noiseThresholdLabel.Size = new Size(116, 21);
            _noiseThresholdLabel.TabIndex = 7;
            _noiseThresholdLabel.Text = "Threshold: 0.30";
            // 
            // _noiseStrengthBar
            // 
            _noiseStrengthBar.BackColor = Color.FromArgb(35, 35, 35);
            _noiseStrengthBar.Enabled = false;
            _noiseStrengthBar.Location = new Point(635, 50);
            _noiseStrengthBar.Maximum = 100;
            _noiseStrengthBar.Name = "_noiseStrengthBar";
            _noiseStrengthBar.Size = new Size(130, 69);
            _noiseStrengthBar.TabIndex = 8;
            _noiseStrengthBar.TickFrequency = 20;
            _noiseStrengthBar.Value = 100;
            _noiseStrengthBar.Scroll += OnNoiseStrengthScroll;
            // 
            // _noiseStrengthLabel
            // 
            _noiseStrengthLabel.AutoSize = true;
            _noiseStrengthLabel.Font = new Font("Segoe UI", 8F);
            _noiseStrengthLabel.ForeColor = Color.FromArgb(180, 180, 180);
            _noiseStrengthLabel.Location = new Point(635, 30);
            _noiseStrengthLabel.Name = "_noiseStrengthLabel";
            _noiseStrengthLabel.Size = new Size(116, 21);
            _noiseStrengthLabel.TabIndex = 9;
            _noiseStrengthLabel.Text = "Strength: 100%";
            // 
            // _controlPanel
            // 
            ...
            _perlinPanel.ResumeLayout(false);
            _perlinPanel.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)_noiseScaleBar).EndInit();
            ((System.ComponentModel.ISupportInitialize)_noiseOctavesBar).EndInit();
            ((System.ComponentModel.ISupportInitialize)_noiseThresholdBar).EndInit();
            ((System.ComponentModel.ISupportInitialize)_noiseStrengthBar).EndInit();
